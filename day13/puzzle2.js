...
function addMyself(parsedInput) {
  parsedInput.people.push("Me");
  let meIdx = parsedInput.people.indexOf("Me");
  parsedInput.happienessMatrix[meIdx] = [];

  for (let subArray of parsedInput.happienessMatrix) {
    subArray.push(0);
    parsedInput.happienessMatrix[meIdx].push(0);
  }
}
